...
class ViewAllFashion extends StatefulWidget {
  ...
  @override
  State<ViewAllFashion> createState() => _ViewAllElectronicsState();
  
} 

class _ViewAllElectronicsState extends State<ViewAllFashion> {
  @override
  void initState() {
         ...
         return     InkWell(
           child: Container(
              ...
              child: GridView.builder(
                ...
                itemCount: state.itemList.fasion!.length,
                  ...
                  return InkWell(
                    onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=> ProductSpecific(
                              qty:state.itemList.fasion![index]!.description.toString() ,
                          ...
                          children: [
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                            image: NetworkImage(
                                                'http://$ip:3000/products-images/${state.itemList.fasion![index]!.image.toString()}'),
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                      ),
                            ...
                            Padding(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("${state.itemList.fasion![index]!.name.toString()}",
                                    style: TextStyle(fontSize: 15.sp, fontWeight: FontWeight.w500,fontFamily: "font2"),),
                                  Text(
                                    state.itemList.fasion![index]!.description.toString(),
                                    maxLines: 1,
                                      style: TextStyle(fontSize: 10.sp, fontWeight: FontWeight.w400,fontFamily: "font2"),
                                  ),
                                  Center(child: Text("₹${state.itemList.fasion![index]!.price.toString()}",
