...
class ViewAllFancy extends StatefulWidget {
  ...
  @override
  State<ViewAllFancy> createState() => _ViewAllElectronicsState();
  
} 

class _ViewAllElectronicsState extends State<ViewAllFancy> {
  @override
  void initState() {
        ...
        if (state is LoadedState){
         ...
         return     Container(
            ...
            child: GridView.builder(
              ...
              itemCount: state.itemList.fancy!.length,
                ...
                return InkWell(
                  onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=> ProductSpecific(
                               qty:state.itemList.fancy![index]!.description.toString() ,
                        ...
                        children: [
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                          image: NetworkImage(
                                              'http://$ip:3000/products-images/${state.itemList.fancy![index]!.image.toString()}'),
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("${state.itemList.fancy![index]!.name.toString()}",
                                  style: TextStyle(fontSize: 15.sp, fontWeight: FontWeight.w500,fontFamily: "font2"),),
                                Text(
                                  state.itemList.fancy![index]!.description.toString(),
                                  maxLines: 1,
                                    style: TextStyle(fontSize: 10.sp, fontWeight: FontWeight.w400,fontFamily: "font2"),
                                ),
                                Center(child: Text("₹${state.itemList.fancy![index]!.price.toString()}",
