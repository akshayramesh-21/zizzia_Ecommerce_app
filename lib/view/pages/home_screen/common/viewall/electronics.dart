...
class ViewAllElectronics extends StatefulWidget {
  ...
  @override
  State<ViewAllElectronics> createState() => _ViewAllElectronicsState();
  
} 

class _ViewAllElectronicsState extends State<ViewAllElectronics> {
  @override
  void initState() {
        ...
        if (state is LoadedState){
         ...
         return     Container(
            ...
            child: GridView.builder(
              ...
              itemCount: state.itemList.electronics!.length,
                ...
                return InkWell(
                  onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=> ProductSpecific(
                            qty:state.itemList.electronics![index]!.description.toString() ,
                        ...
                        children: [
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                          image: NetworkImage(
                                              'http://$ip:3000/products-images/${state.itemList.electronics![index]!.image.toString()}'),
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                  ...
                                  child: CircleAvatar(backgroundColor:Colors.lime.shade300,
                                    child: FavoriteButton(iconDisabledColor: Colors.white,
                                                ...
                                                BlocProvider.of<WishlistBloc>(context)
                                                                 .add(WishListAdd(context: context,id: state.itemList.fasion![index]!.id.toString()));
                          ...
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("${state.itemList.electronics![index]!.name.toString()}",
                                  style: TextStyle(fontSize: 15.sp, fontWeight: FontWeight.w500,fontFamily: "font2"),),
                                Text(
                                  state.itemList.electronics![index]!.description.toString(),
                                  maxLines: 1,
                                    style: TextStyle(fontSize: 10.sp, fontWeight: FontWeight.w400,fontFamily: "font2"),
                                ),
                                Center(child: Text("₹${state.itemList.electronics![index]!.price.toString()}",
